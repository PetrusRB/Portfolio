...
!(function () {
  ...
  if (
    ((window.Promise && Array.from && window.URL && window.Symbol && !m) ||
      (s = ["sd-ce-pf"]),
    s.length)
  ) {
    var u,
      p =
        ...
        (window.trustedTypes &&
          window.trustedTypes.createPolicy("webcomponents-loader", w)) ||
          w),
      f = "bundles/webcomponents-" + s.join("-") + ".js";
    if (window.WebComponents.root)
      ((u = window.WebComponents.root + f),
        window.trustedTypes &&
          window.trustedTypes.isScriptURL(window.WebComponents.root) &&
          (u = p.createScriptURL(u)));
    else {
    ...
    ((h.src = u),
      "loading" === document.readyState
        ? (h.setAttribute(
            "onload",
            p.createScript("window.WebComponents._batchCustomElements()"),
          ),
          document.write(p.createHTML(h.outerHTML)),
